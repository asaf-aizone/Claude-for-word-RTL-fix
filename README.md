...
<strong>תזרים מהיר (4 צעדים):</strong>
<ol>
  <li>פותחים את Word / Excel / PowerPoint / Outlook כרגיל.</li>
  <li>שומרים את העבודה (Ctrl+S). <strong>החיבור יסגור ויפתח מחדש את האפליקציה.</strong></li>
  <li>קליק ימני על אייקון ה-tray ליד השעון, ובוחרים <code>Connect Word</code> (או Excel / PowerPoint / Outlook).</li>
  <li>מאשרים בדיאלוג. האפליקציה תיסגר, תיפתח מחדש עם אותם קבצים, והאייקון יהפוך לירוק - RTL פעיל.</li>
</ol>
</div>
...
<ol>
  <li>פותחים את Word, Excel או PowerPoint איך שרגילים - Start Menu, דאבל-קליק על קובץ, Recent files. (Outlook: ראו <a href="#outlook-section">סקציית Outlook</a> לתזרים ייעודי עם אישור opt-in.)</li>
  ...
  <li>שורת הסטטוס של אותה אפליקציה הופכת ל-<code>connected</code> והאייקון ל<strong>ירוק</strong>. הפאנל RTL. אפשר לחזור על אותו תהליך עבור שאר האפליקציות במקביל.</li>
</ol>
...
<blockquote>
<strong>Quick flow (4 steps):</strong>
<ol>
  <li>Open Word / Excel / PowerPoint / Outlook the way you always do.</li>
  <li>Save your work (Ctrl+S). <strong>Connect will close and reopen the app.</strong></li>
  <li>Right-click the tray icon near the clock and pick <code>Connect Word</code> (or Excel / PowerPoint / Outlook).</li>
  <li>Approve the dialog. The app closes, reopens with the same files, and the tray icon turns green - RTL is active.</li>
</ol>
</blockquote>

<ol>
  <li>Open Word, Excel, or PowerPoint the way you always do - Start Menu, double-click a file, Recent files. (Outlook: see the <a href="#outlook">Outlook section</a> for the opt-in flow.)</li>
