...
> **תזרים מהיר (4 צעדים):**
> 1. פותחים את Word / Excel / PowerPoint / Outlook כרגיל.
> 2. שומרים את העבודה (Ctrl+S). **החיבור יסגור ויפתח מחדש את האפליקציה.**
> 3. קליק ימני על אייקון ה-tray ליד השעון, ובוחרים `Connect Word` (או Excel / PowerPoint / Outlook).
> 4. מאשרים בדיאלוג. האפליקציה תיסגר, תיפתח מחדש עם אותם קבצים, והאייקון יהפוך לירוק - RTL פעיל.
