...
לא צפוי. הכלי רק משנה את אופן התצוגה של הפאנל ב-DOM המקומי שלך. הוא לא משנה מה אתה שולח, מה Claude מחזיר, מגבלות שימוש או מנגנוני הגנה. השימוש שלך ב-Claude נשאר כפוף לתנאי השירות ולמדיניות השימוש של Anthropic ללא קשר לכלי הזה. הכלי לא משנה את מה שנשלח ל-Claude או את מה ש-Claude מחזיר, אלא רק מעצב מחדש את הפלט שכבר עבר רינדור מקומית בדפדפן שלך. אם תנאי Anthropic יתעדכנו אי פעם באופן שיגביל שינויים בצד הלקוח, יש לציית לתנאים שלהם ולא לכלי הזה.
