 ...
 *   Outlook     -> _host_Info=Outlook$Win32$16.02$he-IL$$$$16    (see probe/README.md, v0.3.0 M0)
 *
 * Registering an app in APPS only gives its CDP target a name in the
 * injector log and the per-app status file. Whether the injector actually
 * attaches is governed separately by BLOCKED_HOST_INFO_KEYS + the per-app
 * opt-in flag. Outlook is registered here AND blocked - see below.
 */
...
const APPS = [
  ...
  { name: 'Outlook',    processName: 'OUTLOOK.EXE',  urlHostInfo: 'Outlook' },
];
